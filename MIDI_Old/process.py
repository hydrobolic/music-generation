...
immutableNotes = getImmutableNotes(notes)
with open(notesPath, "wb") as f:
  pickle.dump(immutableNotes, f)


# =============================================================================

elements = list(set(item for item in immutableNotes))

with open(encodingPath, "wb") as f: pickle.dump(elements, f)
